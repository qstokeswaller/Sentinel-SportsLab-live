                        ...
                        <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-2xl p-8 sm:p-10 shadow-sm space-y-5">
                            ...
                            {WHATSAPP_NUMBER && (
                                <a
                                    ...
                                    className="w-full py-3 bg-white hover:bg-emerald-50 text-emerald-700 border-[1.5px] border-emerald-300 hover:border-emerald-400 font-semibold rounded-lg text-sm transition-colors flex items-center justify-center gap-2"
                                >
