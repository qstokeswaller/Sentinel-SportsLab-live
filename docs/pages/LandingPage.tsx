    ...
    return (
        <div className={`min-h-screen ${tx} overflow-x-hidden transition-colors duration-700`} style={{ backgroundColor: bg }}>
            ...
            <nav className={`fixed top-0 inset-x-0 z-50 ${glass} border-b`}>
                <div className="max-w-7xl mx-auto px-8 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={() => nav('/login')} className={`text-[13px] font-medium ${txm} hover:text-indigo-400 transition-colors px-3 py-2`}>Log in</button>
                        <button onClick={() => nav('/login')} className="text-[13px] font-semibold text-white bg-indigo-600 hover:bg-indigo-500 px-5 py-2 rounded-lg transition-all shadow-lg shadow-indigo-600/20 hover:shadow-indigo-500/30">Get Started</button>
                    </div>
                </div>
            </nav>
            ...
            <section className="relative min-h-screen flex items-center justify-center pt-16">
                ...
                <div ref={rHero.ref} style={rHero.style} className="relative max-w-7xl mx-auto px-8 text-center">
                    {/* Badge */}
                    ...
                    {/* Headline — massive */}
                    <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-[-0.03em] leading-[0.95]">
                        Monitor athletes.
                        <br />
                    ...
                    <div className={`mt-14 flex items-center justify-center gap-8 text-sm ${txs}`}>
                        ...
                        <div className={`relative rounded-2xl overflow-hidden transition-transform duration-1000 hover:scale-[1.01]`}
                            ...
                            <div className={`relative ${dark ? 'bg-[#0c0c14]' : 'bg-white'} rounded-2xl p-6 m-px`}>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <div className={`col-span-2 ${dark ? 'bg-white/[0.02]' : 'bg-slate-50'} rounded-xl p-4`}>
            ...
            {/* ═══════ STATS ═══════ */}
            <section className={`py-20 border-y ${dark ? 'border-white/[0.05]' : 'border-slate-100'}`}>
                <div ref={rStats.ref} style={rStats.style} className="max-w-7xl mx-auto px-8 grid grid-cols-3 gap-8 text-center">
                    {[{ end: 80, s: '+', l: 'Testing Protocols' }, { end: 3700, s: '+', l: 'Exercise Library' }, { end: 45, s: '+', l: 'GPS Fields' }].map((s, i) => (
                        <div key={i}>
                            <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent"><Counter end={s.end} suffix={s.s} /></div>
                            <div className={`text-sm ${txm} mt-2 font-medium`}>{s.l}</div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section id="why" className="py-32 relative overflow-hidden">
                ...
                <div ref={rDiff.ref} style={rDiff.style} className="relative max-w-7xl mx-auto px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white">Features nobody else has</h2>
            ...
            <section id="pricing" className="py-32">
                <div ref={rPrice.ref} style={rPrice.style} className="max-w-7xl mx-auto px-8">
                    <div className="text-center mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
                        {[
                            ...
                            <div key={i} className={`relative rounded-2xl p-6 flex flex-col transition-all duration-300 ${
                                t.pop ? 'bg-indigo-600 text-white shadow-2xl shadow-indigo-600/20 scale-[1.03] z-10 ring-1 ring-indigo-500'
            ...
            <section className="py-32 relative overflow-hidden">
                ...
                <div ref={rCta.ref} style={rCta.style} className="relative max-w-3xl mx-auto px-8 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight leading-tight">Ready to elevate your sport science?</h2>
