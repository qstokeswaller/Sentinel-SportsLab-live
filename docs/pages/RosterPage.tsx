                ...
                {teams.map(team => {
                    ...
                    return (
                        <div
                            ...
                            className="bg-white dark:bg-[#132338] rounded-2xl border border-slate-200 dark:border-[#243A58] shadow-sm hover:shadow-md hover:border-indigo-200 dark:border-indigo-800/50 transition-all cursor-pointer group relative overflow-hidden"
                        >
                            {/* Coloured top strip */}
                            ...
                            <div className="p-5">
                                ...
                                {players.length > 0 ? (
                                    ...
                                    <p className="text-xs text-slate-300 dark:text-[#475569] italic">No athletes yet</p>
                                )}

                                {/* CTA */}
                                <div className="mt-4 flex items-center justify-end text-[10px] font-bold text-indigo-400 group-hover:text-indigo-600 dark:text-indigo-300 transition-colors uppercase tracking-wide gap-1">
    ...
    const renderTeamDetail = () => {
        ...
        return (
            <>
                ...
                <div className="flex items-center gap-1 bg-slate-100 dark:bg-[#1A2D48] rounded-lg p-1 w-fit">
                    <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[1, 2, 3].map(i => (
                        <div key={i} className="bg-white dark:bg-[#132338] rounded-xl border border-slate-200 dark:border-[#243A58] shadow-sm p-5 space-y-3">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-[#1A2D48] animate-pulse" />
                                <div className="space-y-1.5">
                                    <div className="h-4 w-24 bg-slate-100 dark:bg-[#1A2D48] rounded animate-pulse" />
                                    <div className="h-3 w-16 bg-slate-50 dark:bg-[#0F1C30] rounded animate-pulse" />
                                </div>
                            </div>
                            <div className="flex gap-2">
                                {[1, 2, 3, 4].map(j => (
                                    <div key={j} className="w-8 h-8 rounded-full bg-slate-100 dark:bg-[#1A2D48] animate-pulse" />
                                ))}
                            </div>
                        </div>
                    ))}
