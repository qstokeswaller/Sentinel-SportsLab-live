                    ...
                    <div className="p-4 space-y-4">
                        ...
                        {programsLoading ? (
                            ...
                            <div className="py-12 text-center">
                                ...
                                <p className="text-sm text-slate-400">{search ? 'No programs found' : 'No programs yet'}</p>
                                {!search && (
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        {filteredTemplates.length === 0 ? (
                            <div className="py-12 text-center">
                                ...
                                <p className="text-sm text-slate-400">{search ? 'No packets found' : 'No workout packets saved yet'}</p>
