...
import { AlertCircle, Dumbbell, Printer, ChevronRight } from 'lucide-react';
...
const ExerciseTable = ({ exercises, sectionLabel }: { exercises: any[]; sectionLabel: string }) => {
        ...
        <div className="mb-6 print:mb-4 print:break-inside-avoid">
            ...
            <div className="space-y-2">
                {exercises.map((ex, idx) => {
                    ...
                    const hasMeta = ex.sets || ex.reps || ex.rest_min || ex.rest_sec || ex.rest || ex.rpe || ex.intensity || ex.tempo || ex.rir;
                    return (
