...
const WattbikeMapCalculator = ({ inline = false }) => {
    ...
    const content = (
        <div className={inline
            ...
            {/* ─── HEADER ─── */}
            <div className="px-7 py-5 border-b border-slate-100 dark:border-[#243A58] flex items-center justify-between shrink-0">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex rounded-xl overflow-hidden border border-slate-200 dark:border-[#243A58]">
                        <button
                            ...
                            className={`px-5 py-2 text-[10px] font-semibold uppercase tracking-wide transition-all ${wbMapTab === 'calc' ? 'bg-indigo-600 text-white' : 'bg-white dark:bg-[#132338] text-slate-400 dark:text-[#94A3B8] hover:text-indigo-500'}`}
                        >
                            Calculator
                        </button>
                        <button
                            onClick={() => setWbMapTab('entry')}
                            className={`px-5 py-2 text-[10px] font-semibold uppercase tracking-wide border-l border-slate-200 dark:border-[#243A58] transition-all ${wbMapTab === 'entry' ? 'bg-indigo-600 text-white' : 'bg-white dark:bg-[#132338] text-slate-400 dark:text-[#94A3B8] hover:text-indigo-500'}`}
                        >
                            Data Entry
                        </button>
                    </div>
                                ...
                                <div className="flex rounded-xl overflow-hidden border border-slate-200 dark:border-[#243A58]">
                                    {['Team', 'Individual'].map((t, i) => (
                                        <button
                                            ...
                                            className={`px-5 py-2 text-[10px] font-semibold uppercase tracking-wide transition-all ${i > 0 ? 'border-l border-slate-200 dark:border-[#243A58]' : ''} ${dataEntryType === t ? 'bg-indigo-600 text-white' : 'bg-white dark:bg-[#132338] text-slate-400 dark:text-[#94A3B8] hover:text-indigo-500'}`}
                                        >
                                            {t}
                                        </button>
                                    ))}
