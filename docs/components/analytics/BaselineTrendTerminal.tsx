        ...
        <div className="space-y-4 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-5 gap-3">
                ...
                <div className="bg-white dark:bg-[#132338] rounded-xl border border-slate-200 dark:border-[#243A58] shadow-sm p-4">
                    <div className="flex items-center gap-1.5 mb-2">
                        ...
                        <div className="text-[9px] font-bold text-slate-400 dark:text-[#64748B] uppercase tracking-wide">Load Baseline</div>
                    </div>
                    <div className="text-2xl font-bold tracking-tight text-slate-900 dark:text-[#E2E8F0]">
                        {hasLoadData ? loadBaseline.toFixed(0) : '—'}
                    </div>
                    <div className="text-[9px] text-slate-400 dark:text-[#64748B] mt-0.5">AU · 28-day avg</div>
                    {hasLoadData && (
                ...
                <div className="bg-white dark:bg-[#132338] rounded-xl border border-slate-200 dark:border-[#243A58] shadow-sm p-4">
                    <div className="flex items-center gap-1.5 mb-2">
                        ...
                        <div className="text-[9px] font-bold text-slate-400 dark:text-[#64748B] uppercase tracking-wide">Load Trend</div>
                    </div>
                ...
                <div className="bg-white dark:bg-[#132338] rounded-xl border border-slate-200 dark:border-[#243A58] shadow-sm p-4">
                    <div className="flex items-center gap-1.5 mb-2">
                        ...
                        <div className="text-[9px] font-bold text-slate-400 dark:text-[#64748B] uppercase tracking-wide">Wellness Baseline</div>
                    </div>
                    <div className="text-2xl font-bold tracking-tight text-slate-900 dark:text-[#E2E8F0]">
                        {hasWellnessData ? wellnessBaseline.toFixed(1) : '—'}
                    </div>
                    <div className="text-[9px] text-slate-400 dark:text-[#64748B] mt-0.5">readiness · /100</div>
                    {hasWellnessData && (
                ...
                <div className={`rounded-xl border shadow-sm p-4 ${acwrZoneBg}`}>
                    <div className="text-[9px] font-bold text-slate-500 dark:text-[#64748B] uppercase tracking-wide mb-2">Current ACWR</div>
                    ...
                    <div className="text-[9px] text-slate-400 dark:text-[#64748B] mt-0.5">7:28 rolling ratio</div>
                </div>
                ...
                <div className="bg-[#0F1C30] dark:bg-[#0A1628] rounded-xl border border-[#243A58] shadow-sm p-4 col-span-2 sm:col-span-1">
                    ...
                    <p className="text-[9px] text-slate-400 dark:text-[#64748B] mt-2 leading-relaxed">
            ...
            {!hasLoadData && !hasWellnessData && (
                <div className="bg-white dark:bg-[#132338] rounded-xl border border-dashed border-slate-200 dark:border-[#243A58] p-12 text-center">
                    ...
                    <h3 className="text-sm font-semibold text-slate-500 dark:text-[#94A3B8] mb-1">No Data Available</h3>
                    <p className="text-xs text-slate-400 dark:text-[#64748B] max-w-sm mx-auto">
