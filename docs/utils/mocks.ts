...
export const BODY_REGIONS = ["Core", "Full Body", "Lower Body", "Upper Body", "Mobility", "Animal Flow", "Balance", "Postural", "Unsorted"];
export const CLASSIFICATIONS = ["Strength", "Power", "Hypertrophy", "Conditioning", "Rehab", "Technical", "Speed", "Plyometric", "Olympic Weightlifting", "Powerlifting", "Bodybuilding", "Calisthenics", "Grinds", "Ballistics", "Unsorted"];
