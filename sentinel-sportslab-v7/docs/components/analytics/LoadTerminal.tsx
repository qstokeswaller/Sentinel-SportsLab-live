...
export const LoadTerminal = ({ loadRegistry, acwrValue, acwrStatus, athleteLoad }) => {
    return (
        <div className="bg-white p-10 rounded-xl border border-indigo-100 dark:border-indigo-800/40 shadow-sm space-y-10">
            <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2">
                    <div className="px-4 py-2 bg-indigo-50 dark:bg-indigo-900/25 rounded-xl text-[10px] font-semibold text-indigo-600 dark:text-indigo-300 uppercase">Pro Logic V4.2</div>
                </div>
            </div>
